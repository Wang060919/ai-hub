    ...
    return `
      <span class="${classes}" ${ariaHidden}>
        <svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <radialGradient id="cf-orbit-app-core-${size}" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(36 36) rotate(90) scale(22)">
              <stop stop-color="#69B8FF"></stop>
              <stop offset="0.48" stop-color="#1E66FF"></stop>
              <stop offset="1" stop-color="#123DCC"></stop>
            </radialGradient>
            <radialGradient id="cf-orbit-app-halo-${size}" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(36 36) rotate(90) scale(30)">
          ...
          <circle cx="36" cy="36" r="22" fill="url(#cf-orbit-app-halo-${size})"></circle>
          <g class="cf-orbit-icon__rotor">
          ...
          <circle cx="36" cy="36" r="15.6" fill="url(#cf-orbit-app-core-${size})"></circle>
