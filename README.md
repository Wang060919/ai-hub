...
| V1.8 | Tauri 桌面体验增强 + Panel 轻量优化 | 待开始 |
...
V1.8 当前主题已改为“Tauri 桌面体验增强 + Panel 轻量优化”。这一阶段不再沿用“手机端 / 局域网 / 室友测试”旧方向，而是在 V1.6 Panel 第一版和 V1.7 Markdown / Obsidian Bridge 第一版的基础上，继续打磨桌面入口体验。第一版目标包括：默认启动体验更偏向 Panel、Tauri 默认窗口尺寸微调、Panel 信息更紧凑，同时保留完整 Chat / Files / Knowledge 页面入口；当前仍不新增后端能力，不扩大 Tauri 权限。
